...
public class AutoPlaceCoralThreeAuto extends SequentialCommandGroup {
  /** Creates a new ElevatorLevelThreeAuto. */
  public AutoPlaceCoralThreeAuto(Elevator elevator, CoralArm coralArm, CoralControl coralControl) {
    ...
    addCommands(
      new ParallelCommandGroup(
        ...
        new CoralMoveArm(coralArm, Constants.Coral.CORAL_ARM_AUTO_THREE)
      ),

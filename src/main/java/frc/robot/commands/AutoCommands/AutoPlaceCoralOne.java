...
public class AutoPlaceCoralOne extends SequentialCommandGroup {
  /** Creates a new ElevatorLevelOneAuto. */
  public AutoPlaceCoralOne(Elevator elevator, CoralArm coralArm, CoralControl coralControl) {
